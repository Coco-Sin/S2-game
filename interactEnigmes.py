...
### différentes possibilités s'offrent à vous
  ...
  while 1:
    ...
    # possibilité b
        ...
        verif3 = u"\n Entrez le code obtenu pour obtenir l'indice. \n NB : Si vous voulez revenir à la carte principale, à tout moment tapez m"
        print verif3
        ...
        ### retourner à la carte principale
          ...
          faux3 = u"\n Non, réessayer \n si vous avez besoin d'aide appuyer sur la touche h une fois sorti de l'énigme (m) et entrez le numéro de l'énigme"
          print faux3
          test3 = raw_input()
    ...
    # possibilité c
        ...
        #### vérification et récupération de l'indice
        verif2 = u"\n Veuillez entrer votre réponse pour vérification. Si vous voulez revenir à la carte principale, à tout moment tapez m"
        print verif2
    ...
    # si on met une lettre différente de celles proposées
      ...
      print u"\n ce n'est pas une lettre valide, veuillez réessayer, sinon tapez m pour revenir à la carte principale"
    ...
    if test1 == "a":
        ...
        if test2 == "A" or test2 == "a" : #Alembert
            ...
            if test3 == "i":
                ...
                ### x4 prend la valeur renvoyée par l'énigme 4 dans le module enigma
                x4 = Enigma.enigma4()
                sys.stdout.write(x4)
                ...
                ### premier nombre ~ chemin 1
                print "\n entrez votre premier nombre:"
                test4 = raw_input()

                if test4 == "10" :  ### on a été obligé car il y avait un soucis pour revenir à la carte (m)
                    ...
                    if test5 == "120" :
                      print "Bonne réponse ! Conservez bien ces nombres et le numéro de l'énigme !!"
                    
                    # revenir à la carte principale
                    test6 = raw_input()
            ...
            ### possibilité iii ~ retourner à la carte principale    
            elif test3 =="iii" or test3 == "m":
              return
            
            ### si on met une lettre différente de celles proposées
            else:
              print u"\n \n ce n'est pas une lettre valide ou alors ce n'est pas une lettre, veuillez réessayer"
        ...
        elif test2 == "E" or test2 == "e" or test2 == "m":
          return
...
def Enigme3():
  ...
  while 1:
      ...
      # possibilité a
      if testcanap == "a" :
          print u"\n Il n'y a rien ici. Choisissez une autre possibilité ou appuyer sur m pour revenir à la carte principale"
      
      # possibilité b 
      elif testcanap == "b" :
          print u"\n le temps passe ......."
          print u"\n Faudrait peut-être avancer un jour"
...
def Enigme5 () :
    ...
    while 1 :
        ...
        if answer == "a" :
          ...
          ### si on met un prénom différent de celui proposé
          else : 
            faux = u"\n ce n'est pas un prénom valide, veuillez réessayer"
            print faux
...
def Enigme6() :
    ...
    while 1 :
        ...
        if answer == "a" :
            ...
            ### vérification et récupération de l'indice
            verif5 = u"\n Veuillez entrer votre réponse pour vérification, vous ecrirez sous la forme ..h.. Pour revenir à la carte, entrez m."
            print verif5
            r5 = raw_input()
